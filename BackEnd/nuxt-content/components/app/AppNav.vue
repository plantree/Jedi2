  ...
  <aside
    ...
    <div class="lg:sticky lg:top-16 overflow-y-auto h-full lg:h-auto lg:max-h-(screen-16)">
      <ul class="p-4 lg:py-8 lg:pl-0 lg:pr-8">
        ...
        <li v-for="(docs, category, index) in categories" :key="category" class="mb-4" :class="{
        ...
        <li class="lg:hidden space-x-2">
          ...
          <div class="flex items-center space-x-4">
            <AppLangSwitcher />
            <AppColorSwitcher />
            <NuxtLink :to="localePath('/about')" class="font-bold inline-flex items-center rounded-lg hover:text-primary-500">
              About
